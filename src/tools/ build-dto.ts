...
import { autoBuildDtoPropertyCallback } from './auto-build-dto-property.callback';
...
/**
 * ATTENTION:
 *    If you want to use the auto option of this decorator (disabled by default)
 *    you have to configure tsconfig with useDefineForClassFields: true
 *    or strictPropertyInitialization: true. If not, any
 *    declared and not initialised property in your DTO
